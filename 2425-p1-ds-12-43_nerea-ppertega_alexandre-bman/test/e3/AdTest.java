...
class AdTest {
    ...
    private static Ad a1, a2, a3, a4, a5, a6, a7, a8;
    ...
    static void setUp() {
        ...
        a6 = new Ad("Engel & Volkers",
                p4,
                AdType.PURCHASE,
                5000
        );

        a7 = new Ad("Engel & Volkers",
                null,
                AdType.PURCHASE,
                5000
        );
    ...
    void isPropertyEqual() {
        ...
        assertFalse(a4.isPropertyEqual(a8)); // a8 = null
    }
    ...
    void dropPrice() {
        ...
        assertNotEquals(a1.getPriceInEuros(), tmp.getPriceInEuros());
    }
    ...
    void testEquals() {
        ...
        /* TODO: Finish. */
        assertEquals(a4, a5);
        assertNotEquals(a4, a6); // Same property, different AdType
        assertNotEquals(a6, a7); // property = null
        assertNotEquals(a4, list);
    }
    ...
    void testHashCode() {
        ...
        assertNotEquals(a4.hashCode(), a6.hashCode()); // Same property, different AdType
    }
}
